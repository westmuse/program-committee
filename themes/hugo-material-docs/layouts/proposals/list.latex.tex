        ...
        {{ if eq .Params.round_number "Round 1" }}
          ...
          \section{ {{.Params.session_title}} }
            \begin{description}
              ...
              {{.Content | replaceRE "<ol>" "\\begin{enumerate}"| replaceRE "<ul>" "\\begin{itemize}"| replaceRE "<li>" "\\item " | replaceRE "<\\/li>" "" | replaceRE "<\\/ol>" "\\end{enumerate}" | replaceRE "<\\/ul>" "\\end{itemize}" | replaceRE "<\\/?p>" "" | replaceRE "\\&" "\\&" | replaceRE "\\$" "\\$" | replaceRE "\\_" "\\_" | replaceRE "\u25CF" "-"}}
              \subsection*{Session Information}
                \begin{description}
                  \item [Format:] {{.Params.session_type | plainify }}
							    ...
							    \item [Objectives:]{{.Params.session_objectives | replaceRE "<\\/?p>" "" | replaceRE "\\&" "\\&" | replaceRE "\\$" "\\$" | replaceRE "\\_" "\\_" | replaceRE "\u25CF" "-" }}
							    \item [Engagement:]{{.Params.session_engagement | replaceRE "<\\/?p>" "" | replaceRE "\\&" "\\&" | replaceRE "\\$" "\\$" | replaceRE "\\_" "\\_" | replaceRE "\u25CF" "-"}}
							    \item [Relationship to Theme:]{{.Params.theme_relationship | replaceRE "<\\/?p>" "" | replaceRE "\\&" "\\&" | replaceRE "\\$" "\\$" | replaceRE "\\_" "\\_" | replaceRE "\u25CF" "-" }}
							    {{ with .Params.theme_comments }}
                    \item [Additional Comments: ]{{ . | replaceRE "<\\/?p>" "" | replaceRE "\\&" "\\&" | replaceRE "\\$" "\\$" | replaceRE "\\_" "\\_" | replaceRE "\u25CF" "-"  }}{{end}}
                \end{description}
              \subsection*{Audience}
                \begin{description}
                  \item [Audiences:]
                    ...
                    {{- range  $audience -}}
									    {{- if eq .Section "audiences" -}}
										     {{ .Title | replaceRE "<\\/?p>" "" | replaceRE "\\&" "\\&" | replaceRE "\\$" "\\$" | replaceRE "\\_" "\\_" | replaceRE "\u25CF" "-" }}~
									    {{- end -}}
								    {{- end }}
                ...
                {{- range $level -}}
									...
									{{- end -}}
								{{- end }}
                \item[Scalability:] {{ .Params.session_scalability | replaceRE "<\\/?p>" "" | replaceRE "\\&" "\\&" | replaceRE "\\$" "\\$" | replaceRE "\\_" "\\_" | replaceRE "\u25CF" "-"  }}
							{{ with .Params.other_comments }}
              \item[Other Comments:] {{ . | replaceRE "<\\/?p>" "" | replaceRE "\\&" "\\&" | replaceRE "\\$" "\\$" | replaceRE "\\_" "\\_" | replaceRE "\u25CF" "-"   }}{{end}}
              \end{description}
            \subsection*{Participants}
              ...
              {{ if ne .Params.moderator.last_name "" }}
                ...
                {{ with .Params.moderator.justification}}{{. | replaceRE "<\\/?p>" "" | replaceRE "\\&" "\\&" | replaceRE "\\$" "\\$" | replaceRE "\\_" "\\_" | replaceRE "\u25CF" "-" }}\newline{{ end }}
              ...
              {{ if ne .Params.pres_1.last_name "" }}
                ...
                {{ with .Params.pres_1.justification}}{{. | replaceRE "<\\/?p>" "" | replaceRE "\\&" "\\&" | replaceRE "\\$" "\\$" | replaceRE "\\_" "\\_" | replaceRE "\u25CF" "-" }}{{ end }}
              ...
              {{ if ne .Params.pres_2.last_name "" }}
                ...
                {{ with .Params.pres_2.justification}}{{. | replaceRE "<\\/?p>" "" | replaceRE "\\&" "\\&" | replaceRE "\\$" "\\$" | replaceRE "\\_" "\\_" | replaceRE "\u25CF" "-" }}{{ end }}
              ...
              {{ if ne .Params.pres_3.last_name "" }}
                ...
                {{ with .Params.pres_3.justification}}{{. | replaceRE "<\\/?p>" "" | replaceRE "\\&" "\\&" | replaceRE "\\$" "\\$" | replaceRE "\\_" "\\_" | replaceRE "\u25CF" "-" }}{{ end }}
              ...
              {{ if ne .Params.pres_4.last_name "" }}
                ...
                {{ with .Params.pres_4.justification}}{{. | replaceRE "<\\/?p>" "" | replaceRE "\\&" "\\&" | replaceRE "\\$" "\\$" | replaceRE "\\_" "\\_" | replaceRE "\u25CF" "-" }}{{ end }}
